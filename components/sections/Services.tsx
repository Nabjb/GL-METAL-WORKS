...
const services: Service[] = [
  {
    ...
    image: "/pics-whatsapp/imggrid1.jpg",
  },
  {
    id: "metal-staircases",
    ...
    image: "/pics-whatsapp/imggrid2.jpg",
  },
  {
    ...
    image: "/pics-whatsapp/imggrid3.jpg",
  },
  {
    ...
    image: "/pics-whatsapp/imggrid4.jpg",
  },
  {
    ...
    image: "/pics-whatsapp/imggrid5.jpg",
  },
  {
    id: "steel-roofing",
    ...
    image: "/pics-whatsapp/imggrid6.jpg",
  },
];
  ...
  return (
    <section id="services" className="relative bg-gray-900">
      ...
      <div className="relative p-3 sm:p-4 lg:p-5">
        <div className="relative h-[85vh] min-h-[600px] overflow-hidden rounded-2xl shadow-2xl">
          {/* Background Images */}
            ...
            <AnimatePresence initial={false}>
              ...
              >
                {current.image.startsWith("http") ? (
                  ...
                  <img
                    src={current.image.replace(/\s/g, "%20")}
                    alt={current.title}
